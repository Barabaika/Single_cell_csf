...
CSF_MS_1.data <- Seurat::CreateSeuratObject(counts = CSF_MS_1.data, min.cells = 3, min.features = 200, project = "CSF_MS_1")
CSF_MS_2.data <- Seurat::CreateSeuratObject(counts = CSF_MS_2.data, min.cells = 3, min.features = 200, project = "CSF_MS_2")
CSF_MS_3.data <- Seurat::CreateSeuratObject(counts = CSF_MS_3.data, min.cells = 3, min.features = 200, project = "CSF_MS_3")
CSF_MS_4.data <- Seurat::CreateSeuratObject(counts = CSF_MS_4.data, min.cells = 3, min.features = 200, project = "CSF_MS_4")
CSF_MS_5.data <- Seurat::CreateSeuratObject(counts = CSF_MS_5.data, min.cells = 3, min.features = 200, project = "CSF_MS_5")
CSF_MS_6.data <- Seurat::CreateSeuratObject(counts = CSF_MS_6.data, min.cells = 3, min.features = 200, project = "CSF_MS_6")

CSF_cont_1.data <- Seurat::CreateSeuratObject(counts = CSF_cont_1.data, min.cells = 3, min.features = 200, project = "CSF_cont_1")
CSF_cont_2.data <- Seurat::CreateSeuratObject(counts = CSF_cont_2.data, min.cells = 3, min.features = 200, project = "CSF_cont_2")
CSF_cont_3.data <- Seurat::CreateSeuratObject(counts = CSF_cont_3.data, min.cells = 3, min.features = 200, project = "CSF_cont_3")
CSF_cont_4.data <- Seurat::CreateSeuratObject(counts = CSF_cont_4.data, min.cells = 3, min.features = 200, project = "CSF_cont_4")
CSF_cont_5.data <- Seurat::CreateSeuratObject(counts = CSF_cont_5.data, min.cells = 3, min.features = 200, project = "CSF_cont_5")
CSF_cont_6.data <- Seurat::CreateSeuratObject(counts = CSF_cont_6.data, min.cells = 3, min.features = 200, project = "CSF_cont_6")
